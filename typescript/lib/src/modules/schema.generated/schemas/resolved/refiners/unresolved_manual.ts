...
export const Package: Package_ = ($, abort, $l, $p) => p_.literal.group_resolve(
    () => {
...
export const Schema_Imports: Schema_Imports_ = ($, abort, $l, $p) => p_variables(
...
export const Resolver_Imports: Resolver_Imports_ = ($, abort, $l, $p) => p_variables(
    () => p_change_context($, ($) => i_generic2.temp_resolve(
        $['l dictionary'],
...
export const Schema_Tree: Schema_Tree_ = ($, abort, $l, $p) => p_variables(
...
export const Schemas: Schemas_ = ($, abort, $l, $p) => p_variables(
...
export const Module_Specification: Module_Specification_ = ($, abort, $l, $p) => p_variables(
    () => ({
        'schema': Schema_Tree(
            $.schema,
            abort,
