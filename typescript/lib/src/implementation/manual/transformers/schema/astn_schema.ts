...
export const Schema: pi.Transformer<d_in.Schema, d_out.Schema> = (
    $
) => ({
...
export const Globals: pi.Transformer<d_in.Globals, d_out.Globals> = (
    $
) => ({
...
export const Schema_Imports: pi.Transformer<d_in.Schema_Imports, d_out.Imports> = (
    $
...
export const Module: pi.Transformer<d_in.Module, d_out.Modules.l_dictionary.D.l_entry> = (
    $
) => ({
    'root value': Value($['root value'])
})

export const Value: pi.Transformer<d_in.Value, d_out.Value> = (
    $
...
export const Text_Type: pi.Transformer<d_in.Text_Type, d_out.Text_Type> = (
    $
) => ({
