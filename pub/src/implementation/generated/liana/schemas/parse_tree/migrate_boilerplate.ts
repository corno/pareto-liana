...
export const Value: t_signatures.Value = ($,) => ({
    'type': _p.deprecated_cc($['type'], ($,) => _p.decide.state($, ($,): t_out.Value.type_ => {
        switch ($[0]) {
            case 'concrete':
                return _p.ss($, ($,) => ['concrete', _p.decide.state($, ($,): t_out.Value.type_.concrete => {
                    switch ($[0]) {
                        case 'dictionary':
                        ...
                        case 'group':
                            return _p.ss($, ($,) => ['group', _p.decide.state($, ($,): t_out.Value.type_.concrete.group => {
                                switch ($[0]) {
                                    case 'concise':
                        ...
                        case 'nothing':
                            return _p.ss($, ($,) => ['nothing', ({
                                '~': _p.deprecated_cc($['~'], ($,) => Structural_Token($)),
                            })])
                        case 'optional':
                            return _p.ss($, ($,) => ['optional', _p.decide.state($, ($,): t_out.Value.type_.concrete.optional => {
                                switch ($[0]) {
                                    case 'set':
                                        return _p.ss($, ($,) => ['set', ({
                                            '*': _p.deprecated_cc($['*'], ($,) => Structural_Token($)),
                        ...
                        case 'state':
                            return _p.ss($, ($,) => ['state', ({
                                '|': _p.deprecated_cc($['|'], ($,) => Structural_Token($)),
                                'status': _p.deprecated_cc($['status'], ($,) => _p.decide.state($, ($,): t_out.Value.type_.concrete.state.status => {
                                    switch ($[0]) {
                                        case 'missing data':
                                            return _p.ss($, ($,) => ['missing data', ({
                                                '#': _p.deprecated_cc($['#'], ($,) => Structural_Token($)),
                                            })])
                                        case 'set':
                                            return _p.ss($, ($,) => ['set', ({
                        ...
                        case 'text':
                            return _p.ss($, ($,) => ['text', Text($)])
                        default:
                            return _p.au($[0])
                    }
                })])
            case 'include':
                return _p.ss($, ($,) => ['include', ({
                    '@': _p.deprecated_cc($['@'], ($,) => Structural_Token($)),
