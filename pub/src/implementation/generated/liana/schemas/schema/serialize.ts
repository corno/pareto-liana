...
import * as t_signatures from "../../../../../interface/generated/liana/schemas/schema/serialize"
...
export const Optional_Value_Initialization: t_signatures.Optional_Value_Initialization = ($) => v_serialize.Document(
    v_marshall.Optional_Value_Initialization(
        $
    )
)
...
export const Possible_Value_Selection: t_signatures.Possible_Value_Selection = ($) => v_serialize.Document(
    v_marshall.Possible_Value_Selection(
        $
    )
)
