...
export const Text_Type: t_signatures.Text_Type = ($) => ({
    'type': _p.deprecated_cc($['type'], ($) => ({
        'location': ({
            'file': "implement me",
            'line': 4.200000000000000e+1,
            'column': 4.200000000000000e+1,
        }),
        'state': _p.deprecated_cc($, ($): t_out.Text_Type.type_.state => {
            switch ($[0]) {
...
export const Number_Type: t_signatures.Number_Type = ($) => ({
    'precision': _p.deprecated_cc($['precision'], ($) => ({
        ...
        'state': _p.deprecated_cc($, ($): t_out.Number_Type.precision.state => {
            switch ($[0]) {
                ...
                case 'exact': return _p.ss($, ($) => ['exact', ({
                    ...
                    'type': _p.deprecated_cc($['type'], ($) => ({
                        ...
                        'state': _p.deprecated_cc($, ($): t_out.Number_Type.precision.state.exact.type_.state => {
                            switch ($[0]) {
...
export const Globals: t_signatures.Globals = ($) => ({
    'complexity': _p.deprecated_cc($['complexity'], ($) => ({
        ...
        'state': _p.deprecated_cc($, ($): t_out.Globals.complexity.state => {
            switch ($[0]) {
...
export const Schema: t_signatures.Schema = ($) => ({
    ...
    'complexity': _p.deprecated_cc($['complexity'], ($) => ({
        ...
        'state': _p.deprecated_cc($, ($): t_out.Schema.complexity.state => {
            switch ($[0]) {
...
export const Schema_Tree: t_signatures.Schema_Tree = ($) => ({
    ...
    'state': _p.deprecated_cc($, ($): t_out.Schema_Tree.state => {
        switch ($[0]) {
...
export const Presence: t_signatures.Presence = ($) => ({
    ...
    'state': _p.deprecated_cc($, ($): t_out.Presence.state => {
        switch ($[0]) {
...
export const Type_Reference: t_signatures.Type_Reference = ($) => ({
    'location': _p.deprecated_cc($['location'], ($) => ({
        ...
        'state': _p.deprecated_cc($, ($): t_out.Type_Reference.location.state => {
            switch ($[0]) {
                case 'internal': return _p.ss($, ($) => ['internal', ({
                    'location': ({
                        'file': "implement me",
                        'line': 4.200000000000000e+1,
                        'column': 4.200000000000000e+1,
...
export const Type_Node: t_signatures.Type_Node = ($) => ({
    ...
    'state': _p.deprecated_cc($, ($): t_out.Type_Node.state => {
        switch ($[0]) {
            ...
            case 'component': return _p.ss($, ($) => ['component', ({
                ...
                'state': _p.deprecated_cc($, ($): t_out.Type_Node.state.component.state => {
                    switch ($[0]) {
                        case 'external': return _p.ss($, ($) => ['external', ({
                            'import': _p.deprecated_cc($['import'], ($) => ({
                                'location': ({
                        ...
                        case 'internal cyclic': return _p.ss($, ($) => ['internal cyclic', ({
                            'location': ({
                                'file': "implement me",
                                'line': 4.200000000000000e+1,
                                'column': 4.200000000000000e+1,
            ...
            case 'number': return _p.ss($, ($) => ['number', ({
                ...
                'state': _p.deprecated_cc($, ($): t_out.Type_Node.state.number_.state => {
                    switch ($[0]) {
                        case 'global': return _p.ss($, ($) => ['global', ({
                            'location': ({
                                'file': "implement me",
                                'line': 4.200000000000000e+1,
                                'column': 4.200000000000000e+1,
            ...
            case 'reference': return _p.ss($, ($) => ['reference', ({
                ...
                'type': _p.deprecated_cc($['type'], ($) => ({
                    ...
                    'state': _p.deprecated_cc($, ($): t_out.Type_Node.state.reference.type_.state => {
                        switch ($[0]) {
                            ...
                            case 'selected': return _p.ss($, ($) => ['selected', ({
                                ...
                                'dependency': _p.deprecated_cc($['dependency'], ($) => ({
                                    ...
                                    'state': _p.deprecated_cc($, ($): t_out.Type_Node.state.reference.type_.state.selected.dependency.state => {
                                        switch ($[0]) {
            ...
            case 'text': return _p.ss($, ($) => ['text', ({
                ...
                'state': _p.deprecated_cc($, ($): t_out.Type_Node.state.text.state => {
                    switch ($[0]) {
                        case 'global': return _p.ss($, ($) => ['global', ({
                            'location': ({
                                'file': "implement me",
    ...
    'tail': _p.deprecated_cc($['tail'], ($) => ({
        ...
        'list': $['list'].__l_map(($) => ({
            'element': _p.deprecated_cc($['element'], ($) => ({
                ...
                'state': _p.deprecated_cc($, ($): t_out.Type_Node_Path.tail.list.L.element.state => {
                    switch ($[0]) {
        ...
        'dictionary': $.__d_map(($) => ({
            'entry': ({
                ...
                'type': _p.deprecated_cc($['type'], ($) => ({
                    ...
                    'state': _p.deprecated_cc($, ($): t_out.Signature_Parameters.lookups.dictionary.D.entry.type_.state => {
                        switch ($[0]) {
                            case 'cyclic': return _p.ss($, ($) => ['cyclic', null])
                            case 'acyclic': return _p.ss($, ($) => ['acyclic', null])
                            case 'stack': return _p.ss($, ($) => ['stack', null])
...
export const Signature: t_signatures.Signature = ($) => ({
    ...
    'parameters': _p.deprecated_cc($['parameters'], ($) => ({
        ...
        'state': _p.deprecated_cc($, ($): t_out.Signature.parameters.state => {
            switch ($[0]) {
                case 'local': return _p.ss($, ($) => ['local', Signature_Parameters(
                    $
                )])
                case 'same as': return _p.ss($, ($) => ['same as', ({
                    'location': ({
                        'file': "implement me",
                        'line': 4.200000000000000e+1,
                        'column': 4.200000000000000e+1,
    ...
    'path': _p.deprecated_cc($['path'], ($) => ({
        ...
        'list': $['list'].__l_map(($) => ({
            'element': _p.deprecated_cc($['element'], ($) => ({
                ...
                'state': _p.deprecated_cc($, ($): t_out.Relative_Value_Selection.path.list.L.element.state => {
                    switch ($[0]) {
...
export const Lookup_Selection: t_signatures.Lookup_Selection = ($) => ({
    'type': _p.deprecated_cc($['type'], ($) => ({
        ...
        'state': _p.deprecated_cc($, ($): t_out.Lookup_Selection.type_.state => {
            switch ($[0]) {
...
export const Constraint: t_signatures.Constraint = ($) => ({
    ...
    'type': _p.deprecated_cc($['type'], ($) => ({
        ...
        'state': _p.deprecated_cc($, ($): t_out.Constraint.type_.state => {
            switch ($[0]) {
                case 'state': return _p.ss($, ($) => ['state', ({
...
export const Option_Constraints: t_signatures.Option_Constraints = ($) => ({
    ...
    'dictionary': $.__d_map(($) => ({
        'entry': ({
            ...
            'state': _p.deprecated_cc($, ($): t_out.Option_Constraints.dictionary.D.entry.state => {
                switch ($[0]) {
                    case 'state': return _p.ss($, ($) => ['state', ({
                        'selection': _p.deprecated_cc($['selection'], ($) => Guaranteed_Value_Selection(
                            $
...
export const Property_Constraint: t_signatures.Property_Constraint = ($) => ({
    'start': _p.deprecated_cc($['start'], ($) => ({
        ...
        'state': _p.deprecated_cc($, ($): t_out.Property_Constraint.start.state => {
            switch ($[0]) {
...
export const Optional_Value_Initialization: t_signatures.Optional_Value_Initialization = ($) => ({
    ...
    'state': _p.deprecated_cc($, ($): t_out.Optional_Value_Initialization.state => {
        switch ($[0]) {
...
export const Node_Resolver: t_signatures.Node_Resolver = ($) => ({
    ...
    'state': _p.deprecated_cc($, ($): t_out.Node_Resolver.state => {
        switch ($[0]) {
            case 'boolean': return _p.ss($, ($) => ['boolean', null])
            case 'component': return _p.ss($, ($) => ['component', ({
                'location': _p.deprecated_cc($['location'], ($) => ({
                    ...
                    'state': _p.deprecated_cc($, ($): t_out.Node_Resolver.state.component.location.state => {
                        switch ($[0]) {
                            case 'external': return _p.ss($, ($) => ['external', ({
                                'import': _p.deprecated_cc($['import'], ($) => ({
                                    'location': ({
                    ...
                    'values': _p.deprecated_cc($['values'], ($) => $.__o_map(($) => ({
                        ...
                        'dictionary': $.__d_map(($) => ({
                            'entry': ({
                                ...
                                'state': _p.deprecated_cc($, ($): t_out.Node_Resolver.state.component.arguments_.O.values.O.dictionary.D.entry.state => {
                                    switch ($[0]) {
                    ...
                    'lookups': _p.deprecated_cc($['lookups'], ($) => $.__o_map(($) => ({
                        ...
                        'dictionary': $.__d_map(($) => ({
                            'entry': ({
                                ...
                                'state': _p.deprecated_cc($, ($): t_out.Node_Resolver.state.component.arguments_.O.lookups.O.dictionary.D.entry.state => {
                                    switch ($[0]) {
            ...
            case 'reference': return _p.ss($, ($) => ['reference', ({
                ...
                'type': _p.deprecated_cc($['type'], ($) => ({
                    ...
                    'state': _p.deprecated_cc($, ($): t_out.Node_Resolver.state.reference.type_.state => {
                        switch ($[0]) {
...
export const Guaranteed_Value_Selection: t_signatures.Guaranteed_Value_Selection = ($) => ({
    'start': _p.deprecated_cc($['start'], ($) => ({
        ...
        'state': _p.deprecated_cc($, ($): t_out.Guaranteed_Value_Selection.start.state => {
            switch ($[0]) {
                ...
                case 'parent sibling': return _p.ss($, ($) => ['parent sibling', ({
                    'location': ({
                        'file': "implement me",
                        'line': 4.200000000000000e+1,
                        'column': 4.200000000000000e+1,
                ...
                case 'option constraint': return _p.ss($, ($) => ['option constraint', ({
                    'location': ({
                        'file': "implement me",
                        'line': 4.200000000000000e+1,
                        'column': 4.200000000000000e+1,
                ...
                case 'constraint': return _p.ss($, ($) => ['constraint', ({
                    'location': ({
                        'file': "implement me",
                        'line': 4.200000000000000e+1,
                        'column': 4.200000000000000e+1,
                    }),
                    'state': _p.deprecated_cc($, ($): t_out.Guaranteed_Value_Selection.start.state.constraint.state => {
                        switch ($[0]) {
                            case 'component': return _p.ss($, ($) => ['component', ({
                ...
                case 'result': return _p.ss($, ($) => ['result', ({
                    'location': ({
                        'file': "implement me",
                        'line': 4.200000000000000e+1,
                        'column': 4.200000000000000e+1,
                    }),
                    'state': _p.deprecated_cc($, ($): t_out.Guaranteed_Value_Selection.start.state.result.state => {
                        switch ($[0]) {
                            case 'list': return _p.ss($, ($) => ['list', ({
                                'property': _p.deprecated_cc($['property'], ($) => ({
                                    'location': ({
...
export const Possible_Value_Selection: t_signatures.Possible_Value_Selection = ($) => ({
    ...
    'state': _p.deprecated_cc($, ($): t_out.Possible_Value_Selection.state => {
        switch ($[0]) {
            case 'parameter': return _p.ss($, ($) => ['parameter', ({
                'location': ({
                    'file': "implement me",
            ...
            case 'result': return _p.ss($, ($) => ['result', ({
                ...
                'state': _p.deprecated_cc($, ($): t_out.Possible_Value_Selection.state.result.state => {
                    switch ($[0]) {
                        case 'state': return _p.ss($, ($) => ['state', ({
                            'property': _p.deprecated_cc($['property'], ($) => ({
                                'location': ({
