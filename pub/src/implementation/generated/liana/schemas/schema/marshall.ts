                            ...
                            return _p.ss(
                                ...
                                ($) => ({
                                    ...
                                    'value': ['group', ['verbose', _p.dictionary.literal(
                                        ({
                                            'significant digits': _p.deprecated_cc(
                                                $['significant digits'], 
                                                ($) => ['text', ({
                                                    'delimiter': ['none', null],
                        ...
                        case 'exact':
                            return _p.ss(
                                ...
                                ($) => ({
                                    ...
                                    'value': ['group', ['verbose', _p.dictionary.literal(
                                        ({
                                            'decimal separator offset': _p.deprecated_cc(
...
export const Signatures: t_signatures.Signatures = ($) => ['dictionary', $.__d_map(
    ($,id) => Signature(
        $
    )
)]
export const Resolvers: t_signatures.Resolvers = ($) => ['dictionary', $.__d_map(
    ($,id) => ['group', ['verbose', _p.dictionary.literal(
        ({
            'signature': _p.deprecated_cc(
                $['signature'], 
                ($) => ['nothing', null]
            ),
            'type resolver': _p.deprecated_cc(
                $['type resolver'], 
                ($) => Node_Resolver(
                    $
                )
...
export const Type_Reference: t_signatures.Type_Reference = ($) => ['group', ['verbose', _p.dictionary.literal(
    ({
        ...
        'resulting type': _p.deprecated_cc(
            $['resulting type'], 
            ($) => ['nothing', null]
        ),
    })
                                                ...
                                                case 'selected':
                                                    return _p.ss(
                                                        ...
                                                        ($) => ({
                                                            ...
                                                            'value': ['group', ['verbose', _p.dictionary.literal(
                                                                ({
                                                                    'dictionary': _p.deprecated_cc(
                                                                        $['dictionary'], 
                                                                        ($) => ['nothing', null]
                                                                    ),
                                                                    'dependency': _p.deprecated_cc(
                                                                        $['dependency'], 
                                                                        ($) => ['state', _p.decide.state(
                                                                            $, 
                                                                            ($): t_out.Value.state => {
...
export const Type_Node_Path: t_signatures.Type_Node_Path = ($) => ['group', ['verbose', _p.dictionary.literal(
    ({
        ...
        'resulting node': _p.deprecated_cc(
            $['resulting node'], 
            ($) => ['nothing', null]
        ),
    })
...
export const Type_Node_Reference: t_signatures.Type_Node_Reference = ($) => ['group', ['verbose', _p.dictionary.literal(
    ({
        'type location': _p.deprecated_cc(
            $['type location'], 
            ($) => Type_Reference(
                $
            )
...
export const Signature_Parameters: t_signatures.Signature_Parameters = ($) => ['group', ['verbose', _p.dictionary.literal(
    ({
        'values': _p.deprecated_cc(
            $['values'], 
            ($) => ['dictionary', $.__d_map(
                ($,id) => ['group', ['verbose', _p.dictionary.literal(
                    ({
                        'data type': _p.deprecated_cc(
                            $['data type'], 
                            ($) => Type_Reference(
                                $
                            )
                        ),
                        'presence': _p.deprecated_cc(
                            $['presence'], 
                            ($) => Presence(
                                $
                            )
...
export const Signature: t_signatures.Signature = ($) => ['group', ['verbose', _p.dictionary.literal(
    ({
        ...
        'resolved parameters': _p.deprecated_cc(
            $['resolved parameters'], 
            ($) => ['nothing', null]
        ),
    })
...
export const Lookup_Selection: t_signatures.Lookup_Selection = ($) => ['group', ['verbose', _p.dictionary.literal(
    ({
                        ...
                        case 'dictionary':
                            return _p.ss(
                                ...
                                ($) => ({
                                    ...
                                    'value': ['group', ['verbose', _p.dictionary.literal(
                                        ({
                                            'selection': _p.deprecated_cc(
                                                $['selection'], 
                                                ($) => Guaranteed_Value_Selection(
                                                    $
                                                )
                                            ),
                                            'selected dictionary': _p.deprecated_cc(
                                                $['selected dictionary'], 
                                                ($) => ['nothing', null]
                                            ),
                                        })
        ...
        'resulting dictionary': _p.deprecated_cc(
                        ...
                        case 'state':
                            return _p.ss(
                                ...
                                ($) => ({
                                    ...
                                    'value': ['group', ['verbose', _p.dictionary.literal(
                                        ({
                                            'selected state': _p.deprecated_cc(
                                                $['selected state'], 
                                                ($) => ['nothing', null]
                                            ),
                        ...
                        case 'optional value':
                            return _p.ss(
                                ...
                                ($) => ({
                                    ...
                                    'value': ['group', ['verbose', _p.dictionary.literal(
                                        ({
                                            'selected optional value': _p.deprecated_cc(
...
export const Option_Constraints: t_signatures.Option_Constraints = ($) => ['dictionary', $.__d_map(
...
export const Property_Constraints: t_signatures.Property_Constraints = ($) => ['dictionary', $.__d_map(
...
export const Node_Resolver_Group: t_signatures.Node_Resolver_Group = ($) => ['dictionary', $.__d_map(
    ($,id) => ['group', ['verbose', _p.dictionary.literal(
        ({
            'definition': _p.deprecated_cc(
                $['definition'], 
                                                        ...
                                                        ($) => ({
                                                            ...
                                                            'value': ['group', ['verbose', _p.dictionary.literal(
                                                                ({
                                                                    ...
                                                                    'optional value': _p.deprecated_cc(
                                                                        $['optional value'], 
                                                                        ($) => ['nothing', null]
                                                                    ),
                                                                    'result': _p.deprecated_cc(
