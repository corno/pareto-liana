        ...
        switch ($[0]) {
            ...
            case 'component': return _p.ss($, ($): t_out.Resolver_Value => {
                const x = $p.definition[0] !== 'component'
                    ...
                    : $p.definition[1]
                const p_location = _p_change_context($.location['l state'], ($): t_out.Resolver_Value.component.location => {
                    switch ($[0]) {
                ...
                const p_signature: t_out.Resolver_Value.component.signature = _p_change_context(p_location, ($) => {
                    switch ($[0]) {
                            ...
                            'lookups': $.lookups.__decide(
                                ($) => _p.optional.literal.set(_i_generic.resolve_dense_dictionary(
                                    ...
                                    ($, id, $acyclic, $cyclic) => _p_change_context($, ($) => {
                                        ...
                                        return _p_change_context($['l entry']['l state'], ($): t_out.Resolver_Value.component.arguments_.O.lookups.O.D => {
                                            switch ($[0]) {
                                                case 'acyclic': return _p.ss($, ($): t_out.Resolver_Value.component.arguments_.O.lookups.O.D => ['acyclic', _p.decide.state($['l state'], ($): t_out.Resolver_Value.component.arguments_.O.lookups.O.D.acyclic => {
                                                    switch ($[0]) {
                                                        case 'not set': return _p.ss($, ($) => ['not set', null])
                                                        default: return _p.au($[0])
                                                    }
                                                })])
                                                case 'cyclic': return _p.ss($, ($): t_out.Resolver_Value.component.arguments_.O.lookups.O.D => ['cyclic', _p.decide.state($['l state'], ($): t_out.Resolver_Value.component.arguments_.O.lookups.O.D.cyclic => {
                                                    switch ($[0]) {
                                                        case 'not set': return _p.ss($, ($) => ['not set', null])
                                                        default: return _p.au($[0])
                                                    }
                                                })])
                                                case 'stack': return _p.ss($, ($) => ['stack', _p.decide.state($['l state'], ($): t_out.Resolver_Value.component.arguments_.O.lookups.O.D.stack => {
                                                    switch ($[0]) {
                                ...
                                ($) => {
                                    ...
                                    return _p.optional.literal.set(_i_generic.resolve_dense_dictionary(
                                        ...
                                        ($, id, $acyclic, $cyclic) => _p_change_context($, ($) => {
                                            ...
                                            const out = _p_change_context($['l entry']['l state'], ($): t_out.Resolver_Value.component.arguments_.O.modules.O.D => {
                                                switch ($[0]) {
            ...
            case 'reference': return _p.ss($, ($): t_out.Resolver_Value => {
                ...
                return ['reference', {
                    'definition': p_definition,
                    'type': _p_change_context($.type['l state'], ($): t_out.Resolver_Value.reference.type_ => {
                        switch ($[0]) {
            ...
            case 'state': return _p.ss($, ($): t_out.Resolver_Value => {
...
export const Relative_Value_Selection: t_signatures.Resolver_Relative_Value_Selection = ($, abort, $l, $p) => _p_variables(() => {
    ...
    const p_path: t_out.Resolver_Relative_Value_Selection.path = _i_generic.temp_map_list_with_state(
        ...
        ($, current): t_out.Resolver_Relative_Value_Selection.path.l_value.L => {
            ...
            return _p_change_context($['l item']['l state'], ($): t_out.Resolver_Relative_Value_Selection.path.l_value.L => {
                switch ($[0]) {
                    case 'component': return _p.ss($, ($): t_out.Resolver_Relative_Value_Selection.path.l_value.L => {
                    ...
                    case 'reference': return _p.ss($, ($): t_out.Resolver_Relative_Value_Selection.path.l_value.L => {
...
export const Guaranteed_Value_Selection: t_signatures.Resolver_Guaranteed_Value_Selection = ($, abort, $l, $p) => _p_variables(() => _p_variables(() => {
    const start_location = $.start['l location']
    const p_start: t_out.Resolver_Guaranteed_Value_Selection.start = _p_change_context($.start['l state'], ($): t_out.Resolver_Guaranteed_Value_Selection.start => {
        switch ($[0]) {
            case 'constraint': return _p.ss($, ($): t_out.Resolver_Guaranteed_Value_Selection.start => ['constraint', _p_change_context($['l state'], ($): t_out.Resolver_Guaranteed_Value_Selection.start.constraint => {
                switch ($[0]) {
            ...
            case 'option constraint': return _p.ss($, ($): t_out.Resolver_Guaranteed_Value_Selection.start => {
            ...
            case 'result': return _p.ss($, ($) => ['result', _p_change_context($['l state'], ($): t_out.Resolver_Guaranteed_Value_Selection.start.result => {
                switch ($[0]) {
                    case 'list': return _p.ss($, ($) => {
                        const loc = $['property']['l location']
                        const p_sibling: t_out.Resolver_Guaranteed_Value_Selection.start.result.list.property = _p_change_context($['property'], ($) => _i_generic.get_entry_acyclic(
                            $l['sibling property resolvers'],
                            $,
                            abort,
                        ))
                    ...
                    case 'state': return _p.ss($, ($) => {
                        const loc = $['property']['l location']
                        const p_sibling: t_out.Resolver_Guaranteed_Value_Selection.start.result.state.property = _p_change_context($['property'], ($) => _i_generic.get_entry_acyclic(
                            $l['sibling property resolvers'],
                            $,
                            abort,
                        ))
                    ...
                    case 'optional value': return _p.ss($, ($) => {
                        const loc = $['property']['l location']
                        const p_sibling: t_out.Resolver_Guaranteed_Value_Selection.start.result.optional_value.property = _p_change_context($['property'], ($) => _i_generic.get_entry_acyclic(
                            $l['sibling property resolvers'],
                            $,
                            abort,
                        ))
            ...
            case 'sibling': return _p.ss($, ($): t_out.Resolver_Guaranteed_Value_Selection.start => ['sibling', _i_generic.get_entry_acyclic(
                $l['sibling property resolvers'],
                $,
                abort,
            )])
            case 'parent sibling': return _p.ss($, ($): t_out.Resolver_Guaranteed_Value_Selection.start => ['parent sibling', _i_generic.get_entry_acyclic(
    ...
    const p_tail = Relative_Value_Selection(
        ...
        null,
        {
            'value': _p_variables(() => {
                ...
                const gvs_start = ($: t_out.Resolver_Guaranteed_Value_Selection.start) => _p_change_context($, ($): t_out.Value => {
                    switch ($[0]) {
        ...
        ($, id, $acyclic, $cyclic) => _p_change_context($, ($) => _p_change_context($['l entry']['l state'], ($) => {
            switch ($[0]) {
                case 'state': return _p.ss($, ($) => ['state', _p_variables(() => {
                    ...
                    const p_selection: t_out.Resolver_Option_Constraints.D.state.selection = _p_change_context($['selection'], ($) => Guaranteed_Value_Selection(
                        $,
                        abort,
                        $l,
                        $p,
                    ...
                    const p_selected_state = p_selection['resulting node'][0] !== 'state' // component constraint ('selection')
                        ...
                        : p_selection['resulting node'][1]
                    const p_option: t_out.Resolver_Option_Constraints.D.state.option = _p_change_context($['option'], ($) => _i_generic.get_entry_acyclic(
...
export const Optional_Value_Initialization: t_signatures.Resolver_Optional_Value_Initialization = ($, abort, $l, $p) => _p_variables(() => _p_change_context($['l state'], ($) => {
    switch ($[0]) {
        case 'not set': return _p.ss($, ($) => ['not set', null])
        case 'set': return _p.ss($, ($) => ['set', Guaranteed_Value_Selection($, abort, $l, $p)])
        case 'selection': return _p.ss($, ($): t_out.Resolver_Optional_Value_Initialization => {
...
export const Possibly_Optional: t_signatures.Resolver_Possible_Value_Selection = ($, abort, $l, $p) => _p_variables(() => {
    return _p_change_context($['l state'], ($) => {
        switch ($[0]) {
            ...
            case 'result': return _p.ss($, ($) => ['result', _p_change_context($['l state'], ($): t_out.Resolver_Possible_Value_Selection.result => {
                switch ($[0]) {
                    case 'state': return _p.ss($, ($) => {
                        const loc = $['property']['l location']
                        const p_sibling: t_out.Resolver_Possible_Value_Selection.result.state.property = _p_change_context($['property'], ($) => _i_generic.get_entry_acyclic(
                            $l['sibling property resolvers'],
                            $,
                            abort,
                        ))
                    ...
                    case 'optional value': return _p.ss($, ($) => {
                        const loc = $['property']['l location']
                        const p_sibling: t_out.Resolver_Possible_Value_Selection.result.optional_value.property = _p_change_context($['property'], ($) => _i_generic.get_entry_acyclic(
                            $l['sibling property resolvers'],
                            $,
                            abort,
                        ))
...
export const Lookup_Selection: t_signatures.Resolver_Lookup_Selection = ($, abort, $l, $p) => _p_variables(() => _p_variables(() => {
    const loc = $.type['l location']
    const p_type: t_out.Resolver_Lookup_Selection.type_ = _p_change_context($['type'], ($) => _p_change_context($['l state'], ($): t_out.Resolver_Lookup_Selection.type_ => {
        switch ($[0]) {
            case 'acyclic': return _p.ss($, ($): t_out.Resolver_Lookup_Selection.type_ => ['acyclic', _p.decide.state($['l state'], ($): t_out.Resolver_Lookup_Selection.type_.acyclic => {
                switch ($[0]) {
            ...
            case 'cyclic': return _p.ss($, ($) => ['cyclic', _p.decide.state($['l state'], ($): t_out.Resolver_Lookup_Selection.type_.cyclic => {
                switch ($[0]) {
                    case 'siblings': return _p.ss($, ($) => ['siblings', $p['current dictionary'].__decide(
                        ($) => $,
                        () => _i_generic.abort.parameter_is_set_assertion("current directory", loc, abort)
