                ...
                _p.refine_without_error_transformation(
                    ...
                    ($v) => _p_variables(() => {
                        ...
                        return [
                            ...
                            _p.handle_error<My_Error_1, My_Error_2>(
                                [
                                    ...
                                    _p.query(
                                        $qr['read file'](
                                            $v.source,
                                            ($): My_Error_2 => ['could not read source', $]
                                        ),
                                        ($) => $,
                                        ($v2) => [
                                                        ...
                                                        switch ($[0]) {
                                                            ...
                                                            case 'could not resolve module': return _p.ss($, ($) => sh.ph.composed([
                                                                t_location_to_fountain_pen.Range(
                                                                    $.location,
                                                                    {
                                                                        'document resource identifier': t_path_to_text.Node_Path($v.source),
