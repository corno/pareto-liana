...
export const Globals: t_signatures.Globals = ($, abort, $l, $p) => _p.group.literal.resolve(
    () => {
        ...
        const prop_simple_types = _p_change_context(
            $['simple types'],
            ($) => _p.dictionary.from.dictionary(
                $['l dictionary'],
            ).resolve(
                ($, id, $a, $c): t_out.Globals.simple_types.D => _p_change_context(
                    $['l entry'],
                    ($) => Simple_Type(
                        $,
                        ($) => abort(
        ...
        return {
            ...
            'simple types': prop_simple_types,
        }
    },
)

export const Simple_Type: t_signatures.Simple_Type = ($, abort, $l, $p) => _p.group.literal.resolve(
    () => {
                        ...
                        ($): t_out.Simple_Type.type_ => {
                            switch ($[0]) {
                                ...
                                case 'number':
                                    return _p.ss(
                                        $,
                                        ($) => ['number', _p.group.literal.resolve(
                                            () => {
                                                ...
                                                const prop_precision = _p_change_context(
                                                    ...
                                                    ($) => _p_variables(
                                                        () => {
                                                            ...
                                                            return _p.decide.state(
                                                                $['l state'],
                                                                ($): t_out.Simple_Type.type_.number_.precision => {
                                                                    switch ($[0]) {
                                                                        case 'approximation':
                                                                            return _p.ss(
                                                                                $,
                                                                            ...
                                                                            return _p.ss(
                                                                                ...
                                                                                ($) => ['exact', _p.group.literal.resolve(
                                                                                    () => {
                                                                                        ...
                                                                                        const prop_number_of_fractional_digits = _p_change_context(
                                                                                        ...
                                                                                        const prop_type = _p_change_context(
                                                                                            ...
                                                                                            ($) => _p_variables(
                                                                                                () => {
                                                                                                    ...
                                                                                                    return _p.decide.state(
                                                                                                        $['l state'],
                                                                                                        ($): t_out.Simple_Type.type_.number_.precision.exact.type_ => {
                                                                                                            switch ($[0]) {
                                                                                                                case 'integer':
                                                                                                                    return _p.ss(
                                                                                                                        $,
                                                                                        ...
                                                                                        return {
                                                                                            'number of fractional digits': prop_number_of_fractional_digits,
                                                                                            'type': prop_type,
                                                                                        }
                                                                                    },
                                                                                )],
                                                    ...
                                                    return _p.ss(
                                                        ...
                                                        ($) => ['global', _p_variables(
                                                            () => {
                                                                ...
                                                                return {
                                                                    'l entry': _p_sl.acyclic.from_resolved_dictionary(
                                                                        var_constraint_globals['simple types'],
                                                                    ).get_entry(
                                                                        $['l reference'],
                                                                        {
                                                                            no_such_entry: () => abort(
                                        ...
                                        ($) => {
                                            switch ($[0]) {
                                                ...
                                                default:
                                                    return abort(
                                                        {
                                                            'type': ['option constraint', ['no such option', "simple"]],
                                                            'location': var_location,
                                                        },
                                                    )
                                            }
                                        ...
                                        () => {
                                            ...
                                            const prop_options = _p_change_context(
                                                ...
                                                ($) => _p.dictionary.from.dictionary(
                                                    ...
                                                    ($, id, $a, $c): t_out.Resolver_Value.state.options.D => _p_change_context(
                                                        $['l entry'],
                                                        ($) => _p_variables(
                                                            () => {
